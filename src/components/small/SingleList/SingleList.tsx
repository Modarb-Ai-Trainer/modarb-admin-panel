...
const SingleList:React.FC<SingleListProps> = (props:SingleListProps) => {
    const expectedDurationRangeString = `${props.expectedDurationRange.min} - ${props.expectedDurationRange.max}`;
  ...
  return (
    <div className={styles.SingleList}>
        <ul className={styles.SingleList_list}>
              ...
              <li><span className={styles.SingleList_list_prop}>expectedDurationRange :</span><span className={styles.SingleList_list_value}>{expectedDurationRangeString}</span></li>
